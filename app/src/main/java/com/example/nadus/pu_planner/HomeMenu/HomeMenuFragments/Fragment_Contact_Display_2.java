...
public class Fragment_Contact_Display_2 extends Fragment {
...
//                    startActivity(i);
    ...
    private class MyTask extends AsyncTask<String, Integer, String>
    {
        ...
        protected String doInBackground(String... strings) {
            ...
            String temp4 = Fragment_AllContacts_4.current_contact;

            databaseReference = FirebaseDatabase.getInstance().getReference().child("AllContactDiary").child(temp).child(temp2).child(temp3).child(temp4);
